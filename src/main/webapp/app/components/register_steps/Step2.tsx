...
function Step2({handleNext, handleBack}) {
    ...
    const handleSubmit = (event) => {
        ...
        if (country === "" || city === "" || bank === "") {
            return ''
        } else {
            setInfoBank([{id, pays, ville, banque}, ...infoBank])
            // setTypeID('')
            // setNumID('')
              ...
              >
                ...
                />
                  <Autocomplete
                    ...
                    id="controllable-states-demo"
                    options={options}
                    sx={{ width: 280, flex: '1 1 100%'  }}
                    renderInput={(params) => <TextField {...params} label="Banque" focused required/>}
                />
                  ...
                  {country === "" || city === "" || bank === ""? 
                    ...
                    : 
                    <Button type="submit" sx={{ height: 55, flex: '1 1 70%', fontSize: 14, fontWeight: 'bold'}} variant="contained" color="primary" onClick={handleNext}>valider</Button>
                  }
              </Box>
            </Box>
        </Box>
