...
import com.cst.iswift.IswiftAdminApp;
import com.cst.iswift.config.AsyncSyncConfiguration;
...
@SpringBootTest(classes = { IswiftAdminApp.class, AsyncSyncConfiguration.class })
